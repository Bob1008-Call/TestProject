...
static const char qt_meta_stringdata_CustomLineEdit[] = {
    "CustomLineEdit\0\0moveCalendarPos()\0"
};
...
void CustomLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->moveCalendarPos(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData CustomLineEdit::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CustomLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_CustomLineEdit,
      qt_meta_data_CustomLineEdit, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CustomLineEdit::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CustomLineEdit))
