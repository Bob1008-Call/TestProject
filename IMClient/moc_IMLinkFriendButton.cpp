...
void IMLinkFriendButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        IMLinkFriendButton *_t = static_cast<IMLinkFriendButton *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData IMLinkFriendButton::staticMetaObjectExtraData = {
...
const QMetaObject IMLinkFriendButton::staticMetaObject = {
    { &IMLinkButton::staticMetaObject, qt_meta_stringdata_IMLinkFriendButton,
      qt_meta_data_IMLinkFriendButton, &staticMetaObjectExtraData }
};
