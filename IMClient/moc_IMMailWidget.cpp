...
void IMMailWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        IMMailWidget *_t = static_cast<IMMailWidget *>(_o);
        switch (_id) {
        case 0: _t->setInMailsWidget((*reinterpret_cast< const QVector<MailInformation>(*)>(_a[1]))); break;
        case 1: _t->setOutMailsWidget((*reinterpret_cast< const QVector<MailInformation>(*)>(_a[1]))); break;
        case 2: { bool _r = _t->addInMailButton((*reinterpret_cast< const MailInformation(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 3: { bool _r = _t->addOutMailButton((*reinterpret_cast< const MailInformation(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 4: _t->deleteMail((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 5: { bool _r = _t->addNewOutMailButton((*reinterpret_cast< const MailInformation(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 6: { bool _r = _t->addNewInMailButton((*reinterpret_cast< const MailInformation(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        default: ;
        }
    }
...
const QMetaObjectExtraData IMMailWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject IMMailWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_IMMailWidget,
      qt_meta_data_IMMailWidget, &staticMetaObjectExtraData }
};
