...
void IMFlockMemberListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData IMFlockMemberListWidget::staticMetaObjectExtraData = {
...
const QMetaObject IMFlockMemberListWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_IMFlockMemberListWidget,
      qt_meta_data_IMFlockMemberListWidget, &staticMetaObjectExtraData }
};
