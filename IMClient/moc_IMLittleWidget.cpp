...
void IMLittleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        IMLittleWidget *_t = static_cast<IMLittleWidget *>(_o);
        switch (_id) {
        case 0: _t->onClickedBtnOk(); break;
        case 1: _t->onClickedBtnClose(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData IMLittleWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject IMLittleWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_IMLittleWidget,
      qt_meta_data_IMLittleWidget, &staticMetaObjectExtraData }
};
