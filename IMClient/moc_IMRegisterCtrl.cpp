...
void IMRegisterCtrl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        IMRegisterCtrl *_t = static_cast<IMRegisterCtrl *>(_o);
        switch (_id) {
        case 0: _t->signalResetBtnRegister((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->requestRegister(); break;
        case 2: _t->readMessage(); break;
        case 3: _t->resetBtnRegister(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData IMRegisterCtrl::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject IMRegisterCtrl::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_IMRegisterCtrl,
      qt_meta_data_IMRegisterCtrl, &staticMetaObjectExtraData }
};
