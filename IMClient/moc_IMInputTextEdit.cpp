...
void IMInputTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        IMInputTextEdit *_t = static_cast<IMInputTextEdit *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData IMInputTextEdit::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject IMInputTextEdit::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_IMInputTextEdit,
      qt_meta_data_IMInputTextEdit, &staticMetaObjectExtraData }
};
