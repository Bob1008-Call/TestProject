...
void IMLinkFlockButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        IMLinkFlockButton *_t = static_cast<IMLinkFlockButton *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData IMLinkFlockButton::staticMetaObjectExtraData = {
...
const QMetaObject IMLinkFlockButton::staticMetaObject = {
    { &IMLinkButton::staticMetaObject, qt_meta_stringdata_IMLinkFlockButton,
      qt_meta_data_IMLinkFlockButton, &staticMetaObjectExtraData }
};
